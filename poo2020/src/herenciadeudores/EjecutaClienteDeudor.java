            ...
            switch (opcion){
                case 1:
                    ...
                    cadena = String.format("%s%5d%20s%12s%20.3f%30.3f%20.3f\n", cadena, count,
                            pH.getNombre(), pH.getNumeroC(), pH.calcularInteresHip(),pH.totalInteres(),
                ...
                case 2:
                    ...
                    cadena = String.format("%s%5d%20s%12s%20.3f%30.3f%20.3f\n", cadena, count, pA.getNombre()
                            , pA.getNumeroC(), pA.calcularInteresAu(), pA.totalInteres(), pA.totalInteres()+capital);
                    break;
                case 3:
                    count += 1;
                    System.out.println("Ingrese su nombre:");
                    ...
                    cadena = String.format("%s%5d%20s%12s%20.3f%30.3f%20.3f\n", cadena, count, pP.getNombre()
                            , pP.getNumeroC(), pP.calcularInteresPer(), pP.totalInteres(), pP.totalInteres()+capital);
                    break;
                case 4:
